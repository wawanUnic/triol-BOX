...
```
Это же можно сдленать и в PuTTY : Connection → SSH → Auth → Tunnels. Теперь в браузере открываем http://localhost:8080 и весь трафик идёт внутри SSH‑шифрования, а веб‑интерфейс фактически защищен.
